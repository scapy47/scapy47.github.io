...
* graphics to display what you see on a display
**Euclidean space** is made up of **n**-spaces here **n** is positive integer and can be imagined as graph. which is very useful because concepts like force and fields can be imagined or calculated with mathematical operations just like for graphs.
